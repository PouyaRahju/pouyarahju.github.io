...
def main():
    ...
    parser.add_option('-w', '--write', action='store_true', help='Write 5 files to disk with the loads.')
    ...
    for ipid in uniqipids.keys():
        ...
        processit = input("Reassemble packets between hosts " + str(a[0][IP].src) + " and " + str(a[0][IP].dst) + "? [Y/N]")
